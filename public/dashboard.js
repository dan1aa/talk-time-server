window.onload = function () {
    ...
    users.forEach(user => {
        user.onclick = function() {
            let link = `https://talk-time-server.onrender.com/feedbacks/${url}/${this.querySelector('div > .username-graph').textContent}`;
    ...
    addConclusionButton.onclick = function () {
        ...
        fetch(`https://talk-time-server.onrender.com/newconclusion/${url}`, {
            method: 'POST',
            headers: {
